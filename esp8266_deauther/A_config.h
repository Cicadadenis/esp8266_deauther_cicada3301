...
// Observability (logger.cpp) — does not change runtime behaviour when enabled
#define DIAG_ENABLE 1
#define DIAG_LOG_LEVEL 1   // 0=DEBUG (per-loop P0–P4), 1=INFO, 2=WARN, 3=ERROR
...
// Headless build (no OLED / buttons) — saves flash and loop time
#define USE_DISPLAY 0

// Release diagnostics off for headless NodeMCU-class builds (logger stubs remain)
#undef DIAG_ENABLE
...
// ===== SIMPLE LED ON PIN D2 ===== //
#define SIMPLE_LED_PIN 4  // D2 (GPIO4)
