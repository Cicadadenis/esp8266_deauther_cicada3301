...
const char CLI_CAPTURE[] PROGMEM = "capture";                  // capture
const char CLI_HANDSHAKE[] PROGMEM = "handshake";              // handshake
...
const char CLI_DEFAULT_AUTOSTART[] PROGMEM = "sysinfo\n";
...
const char ST_DEVICE_PRIVATE[] PROGMEM  = "Private MAC";
const char ST_DEVICE_UNKNOWN[] PROGMEM  = "Unknown";
...
const char SS_JSON_LISTSIZE[] PROGMEM = "listSize";
const char CLI_LISTSIZE[] PROGMEM = "listsize,-ls";
...
const char S_JSON_WORKMODE[] PROGMEM = "workmode";
